          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700 animate-fade-in">
            <div className="space-y-8 text-gray-700 dark:text-gray-300">
              ...
              <div>
                ...
                <p className="mb-4">
                  Cada plano inclui um número específico de ajustes: plano essencial (2 ajustes, R$150/ajuste adicional), Completo (5 ajustes, R$150/ajuste) e PRO (8 ajustes, R$150/ajuste adicional). Os ajustes são entregues em até 72 horas.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  A I9 Appify trabalha constantemente para aprimorar seus Serviços. Buscamos sempre melhorar a plataforma e poderemos adicionar novas funcionalidades ou recursos para oferecer uma experiência cada vez melhor. Em casos excepcionais, quando necessário, poderemos também descontinuar algumas funcionalidades ou, muito raramente, um serviço específico.
                </p>
              </div>
